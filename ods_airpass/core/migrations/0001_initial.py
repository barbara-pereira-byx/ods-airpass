# Generated by Django 5.1.2 on 2024-10-17 11:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aviao', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.aviao', verbose_name='Avião')),
                ('piloto', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.piloto', verbose_name='Piloto')),
            ],
            options={
                'verbose_name': 'Voo',
